...
########################################################################
#Run status
deformInput=int(sys.argv[3])#determines whether to generate the deformed frames or go to prediction ot training mode
if deformInput==1:
...
verbose=True
if deformInput==2:#goes to prediction mode
    requeue=True
    skiptrain=True
else:
    requeue=False
