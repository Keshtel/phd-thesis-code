'''
This scripts converts .nd2 files from Nikon NIS into h5
files readable by Targettrack's GUI. The h5 file includes
volume t in nd2 file as as dataset "t/frame" it also saves
the time stamp of the middle Z stack of each volume in "t/time" dataset.
run the script from terminal by:
python3 nd22h5.py nd2_directory/nd2File.nd2 output/directory/output_name.h5
where output_name.h5 is the output h5 file after conversion
'''
